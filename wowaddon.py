...
VERSION = '2023.10.0'  # year.month.build_num

ADDON_NAME = 'DropTrash'  # Directory and zip name
ADDON_NAME_CLASSIC = ADDON_NAME  # Directory and zip name
ADDON_TITLE_CLASSIC = "DropTrash Bag Cleaner"  # Title field in TOC
...
UI_VERSION_CLASSIC_WOTLK = '30403'  # patch 3.4.2 WotLK (ICC)
